...
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/composer/vendor/autoload.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/API/validationAPI.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/API/empleadoAPI.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/API/loginAPI.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/API/cocheraAPI.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/API/vehiculoAPI.php";
...
$app->group('/vehiculos', function () {
	...
	$this->post('/entrada[/]', \vehiculoAPI::class . ':entrada')->add(\validationAPI::class . ':usuarioLogeadoValidationMiddleware'); //5- Cuando ingresa el vehículo se le toma la patente, color y marca.

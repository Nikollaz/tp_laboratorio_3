...
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/Entidades/vehiculo.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/SQL/AccesoDatos.php";
include_once $_SERVER['DOCUMENT_ROOT']."/TPFinal/Src/API/PHP/EntidadesPDO/empleadoPDO.php";
...
abstract class vehiculoPDO{
	...
	public function salida($vehiculo)
	{

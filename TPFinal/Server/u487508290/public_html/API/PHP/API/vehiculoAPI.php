...
class vehiculoAPI extends vehiculo implements IApiUsable{
    ...
    * @apiParam {String} foto Foto del vehiculo
    ...
    */
    ...
    { 
            ...
            )
        {
            ...
            $vehiculo->Foto = $ArrayDeParametros['foto'];
    ...
    public function entrada($request, $response, $args)
    {
            ...
            )
        {
                ...
                )
            {
                ...
                $a = (int) vehiculoPDO::entrada($vehiculo);
                ...
                } else if($a == 2)
                {
                    $newBody = [
                        "Estado" => "Error",
                        "Mensaje" => "La cochera esta ocupada"
                    ];
    ...
    public function salida($request, $response, $args)
    {
            ...
            )
        {
            ...
            if(vehiculoPDO::estacionadoValidation($ArrayDeParametros['patente']) != [] ){
                ...
                $cocheraId = cocheraPDO::traerIdCocheraPorNombre($vehiculoEstacionado->Cochera);
		        $vehiculoSalida->Cochera = $cocheraId;
